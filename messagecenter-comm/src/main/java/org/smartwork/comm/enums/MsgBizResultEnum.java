...
public enum MsgBizResultEnum {
	...
	MSG_TYPE_EXISTS("006002002","业务编码已存在","%s业务编码已存在"),
	N_RELEASE_OR_CANCELLED("006002003","广告已发布/已取消","%s已发布/已取消"),
	N_CANCELLED("006002004","广告已取消","%s已取消"),
	HAVE_RELEASED("006002005","新闻已发布不允许编辑","%s新闻已发布不允许编辑"),
	HAVE_RELEASED_DEL("006002006","新闻已发布不允许删除","%s新闻已发布不允许删除"),
	NEW_HAVE_RELEASED_DEL("006002006","该新闻分类下存在新闻，无法删除","%s该新闻分类下存在新闻，无法删除"),

	AD_HAVE_RELEASED_DEL("006002007","广告已发布不允许删除","%s广告已发布不允许删除"),
	ADVERT_HAVE_RELEASED_DEL("006002007","该广告位下存在广告，无法删除","%s该广告位下存在广告，无法删除"),
	;
